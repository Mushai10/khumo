...
function HeroTwo({ heroBoxedItems, settings }) {
    ...
    'inline-flex items-center bg-secondary text-white leading-[38px] text-[15px] h-[38px] px-5 mb-[20px]';
    return (
                ...
                <SwiperComps settings={settings}>
                    {heroBoxedItems?.map((heroBoxedItem, idx) => (
                        <Slide key={heroBoxedItem.id}>
                            <div className="bg-[#ffd6e9] md:h-[600px] h-[500px] flex items-center">
